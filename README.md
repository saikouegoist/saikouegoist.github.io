...
│                                # build-mirrors.py (index.html -> static mirrors)
├── .github/workflows/           # gallery-manifest.yml, music-manifest.yml,
│                                # mirrors.yml (auto-update on push)
...
├── index.html                   # Main SPA shell + source of truth for about/articles/
│                                # notes/projects/links/guestbook static mirrors
│                                # (AUTO-GENERATED by scripts/build-mirrors.py — do not hand-edit mirrors)
